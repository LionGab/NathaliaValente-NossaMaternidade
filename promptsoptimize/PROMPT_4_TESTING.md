...
1. PLAN MODE (Shift+Tab 2x)
   ...
   - Estrutura: __tests__/unit/[hook/service].test.ts
...
2. STEP 1: Criar arquivo test (useTheme) (15 min)
   a) TDD: Escrever testes que FALHAM
      - Arquivo: src/hooks/__tests__/useTheme.test.ts
...
3. STEP 2: Criar arquivo test (AppError) (15 min)
   a) TDD: Escrever testes que FALHAM
      - Arquivo: src/utils/__tests__/error-handler.test.ts
...
4. STEP 3: Criar arquivo test (premium-store) (20 min)
   a) TDD: Escrever teste que FALHA
      - Arquivo: src/state/__tests__/premium-store.test.ts
...
src/state/__tests__/premium-store.test.ts
