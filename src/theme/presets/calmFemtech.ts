...
export const brand = {
  /**
   * Primary: Azul Calmo
   * Domina superfícies e estrutura
   */
  primary: {
    50: "#F0F7FF",
    100: "#DCEBFA",
  ...
  /**
   * Accent: Rosa CTA
   * Uso pontual - máximo 12% da tela
   * IMPORTANTE: Texto em rosa deve ser navy/escuro (não branco)
   */
  accent: {
    50: "#FFF5F7",
    100: "#FFE8ED",
   ...
   * Elementos secundários, meditação, bem-estar
   */
  secondary: {
    50: "#FAF5FF",
    100: "#F3E8FF",
  ...
  /**
   * Teal: Saúde e Bem-estar
   * Indicadores de progresso, badges de saúde
   */
  teal: {
    50: "#F0FDFA",
    100: "#CCFBF1",
